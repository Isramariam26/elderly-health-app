  ...
  return (
    <div className="auth-layout">
      <div className="logo-container">
        ...
        <h1 style={{fontSize: '2rem', fontWeight: 800, color: '#1d1d1f'}}>CareNest</h1>
      </div>
      <p className="auth-subtitle">Comprehensive home care management for patients, families, and caregivers</p>
