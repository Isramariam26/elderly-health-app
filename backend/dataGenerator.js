  ...
  patients: [
    {
      ...
      risks: ['Fall Risk', 'Wandering'],
      emergencyContact: { name: 'Sarah Dent (Daughter)', phone: '+1-555-0100' }
    },
    {
       id: 'p2',
       name: 'Robert Chen',
       ...
       risks: ['Hypoglycemia'],
       emergencyContact: { name: 'Emily Chen (Wife)', phone: '+1-555-0200' }
    },
    {
       id: 'p3',
       name: 'Eleanor Davis',
       ...
       history: ['Arthritis'],
       risks: ['Mobility Impairment'],
       emergencyContact: { name: 'Michael Davis (Son)', phone: '+1-555-0300' }
    }
  ],
  caretakers: [
    {
